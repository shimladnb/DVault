...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 420.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 360.0, 59.0, 22.0 ],
					"text" : "route text"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 165.0, 390.0, 71.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 165.0, 450.0, 57.0, 22.0 ],
					"text" : "s noData"
				}
...
,
					"patching_rect" : [ 181.0, 570.0, 58.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 115.0, 570.0, 61.0, 22.0 ],
					"text" : "r toText3d"
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.5, 317.0, 122.0, 22.0 ],
									"text" : "append % forestation"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 147.5, 287.0, 114.0, 22.0 ],
									"text" : "zl reg"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.0, 242.0, 71.0, 22.0 ],
									"text" : "text no data"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 135.0, 212.0, 44.0, 22.0 ],
									"text" : "sel 1 0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 135.0, 122.0, 59.0, 22.0 ],
									"text" : "route text"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 135.0, 152.0, 71.0, 22.0 ],
									"text" : "fromsymbol"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 135.0, 90.0, 114.0, 22.0 ],
									"text" : "t l l"
								}
...
,
					"patching_rect" : [ 60.0, 510.0, 79.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.518893, 0.518878, 0.518887, 1.0 ],
						"bgcolor" : [ 1.0, 0.999974, 0.999991, 1.0 ],
						"color" : [ 1.0, 0.385962, 0.293389, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 60.0, 285.0, 97.0, 22.0 ],
					"text" : "getSpecificIndex"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 60.0, 540.0, 242.0, 22.0 ],
					"text" : "jit.gl.text3d textLayer @scale 0.17 0.17 0.17"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 75.0, 255.0, 135.0, 22.0 ],
					"text" : "print #1 "
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 60.0, 225.0, 163.0, 22.0 ],
					"text" : "zl reg @zlmaxsize 99999999"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 270.0, 105.0, 77.0, 22.0 ],
					"text" : "r loadedXML"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 153.0, 135.0, 22.0, 22.0 ],
					"text" : "t b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 204.0, 195.0, 176.0, 22.0 ],
					"text" : "zl group @zlmaxsize 99999999"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 204.0, 15.0, 116.0, 22.0 ],
					"text" : "r #1"
				}
